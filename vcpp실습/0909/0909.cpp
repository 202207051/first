...
//마우스의 이전 좌표를 보관하기 위한 전역변수
//전역 번수의 특징 : 항상 0으로 초기화 된다. Data 영역에 존재하기 때문에 어디서나 보인다.
int g_x;	///마우스 이전 x 좌표 값 보관
int g_y;	///마우스 이전 y 좌표 값 보관
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_PAINT:
	{
		...
		*/
		...
		/*
		Rectangle(hdc, NULL, NULL, g_x, g_y);
